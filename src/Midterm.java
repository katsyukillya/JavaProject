...
public class Midterm {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Thank you for using Handy Calculator program.");
    }
    ...
    private static void addNumbers() {
        ...
        System.out.printf("Result of addition " + joinNumbers(numbers, "and", true) + " is %8.2f", result);
    }
    ...
    private static void subtractNumbers() {
        ...
        System.out.printf("Result of subtraction " + joinNumbers(numbers, "from", false) + " is %8.2f", result);
    }
    ...
    private static void multiplyNumbers() {
        ...
        System.out.printf("Result of multiplying " + joinNumbers(numbers, "by", true) + " is %8.2f", result);
    }
    ...
    private static void divideNumbers() {
        ...
        System.out.printf("Result of division " + joinNumbers(numbers, "by", true) + " is %8.2f", result);
    }
     ...
     */
    private static String joinNumbers(List<Number> numbers, String separator, boolean isLeftToRight) {
    ...
    private static int getMainMenuChoice() {
        System.out.println("Welcome to Handy Calculator program");
        System.out.println("\n");
